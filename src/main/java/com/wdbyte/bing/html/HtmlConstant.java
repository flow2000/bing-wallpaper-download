...
public class HtmlConstant {
    ...
    public static class ImgCard {
        ...
        private static final String IMG_CARD = ""
            ...
            +"  <img alt=\"必应壁纸\" class=\"smallImg\" src=\"${img_card_url}&pid=hp&w=50\"  style=\"width:95%;\" />"
            + " <img alt=\"必应壁纸\" class=\"bigImg\" src=\"${img_card_url}&pid=hp&w=384&h=216&rs=1&c=4\" style=\"width:95%\" onload=\"imgloading(this)\">\n"
